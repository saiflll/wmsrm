...
export default function OutboundPage() {
  ...
  const barangOpts = barangs.map((b: any) => ({
    value: String(b.id),
                ...
                <Box style={{ overflowX: "auto" }}>
                  <Table withTableBorder withColumnBorders style={{ fontSize: 11 }}>
                    <Table.Thead style={{ background: "#1a1a1a" }}>
                      <Table.Tr>
                        <Table.Th style={{ color: "#fff", cursor: "pointer" }} onClick={() => handleSort("no_ref")}>NoPO/Ref{sortIcon("no_ref")}</Table.Th>
                        <Table.Th style={{ color: "#fff", cursor: "pointer" }} onClick={() => handleSort("barang.nama")}>Item{sortIcon("barang.nama")}</Table.Th>
                        <Table.Th style={{ color: "#fff", cursor: "pointer" }} onClick={() => handleSort("created_at")}>Tgl Keluar{sortIcon("created_at")}</Table.Th>
                        ...
                        <Table.Th style={{ color: "#fff", cursor: "pointer" }} onClick={() => handleSort("tujuan")}>Tujuan{sortIcon("tujuan")}</Table.Th>
