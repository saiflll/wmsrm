...
import { Box, Group, Button, Title, Text, Badge, Paper, Stack, TextInput, Select, NumberInput, Textarea, ActionIcon, Grid, Autocomplete, Divider } from '@mantine/core';
            ...
            <Box p="md">
                <Grid gutter="md">
                    ...
                    <Grid.Col span={{ base: 12, md: 8, lg: 9 }}>
                        ...
                        {/* Existing Plans Table (read-only) */}
                        <Paper withBorder p="md" radius="md" style={{ background: '#fff' }}>
                            <Group justify="space-between" mb="xs">
                            ...
                            <Box style={{ overflowX: 'auto' }}>
                                <Table withTableBorder withColumnBorders style={{ fontSize: 11 }}>
                                    <Table.Thead style={{ background: '#333' }}>
                                        <Table.Tr>
                                            {['Item', 'Qty', 'Tgl Planning', 'Shift', 'Tujuan', 'Status', 'Keterangan'].map((h) => (
                                                <Table.Th key={h} style={{ color: '#fff' }}>{h}</Table.Th>
                                            ))}
                                        </Table.Tr>
                                    </Table.Thead>
