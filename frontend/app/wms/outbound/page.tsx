...
export default function OutboundPage() {
  ...
  const filteredLogs = outboundLogs.filter(
    (l: any) =>
      !filterRak ||
    ...
    <Box>
      ...
      >
        <Group justify="space-between">
          <Title order={3} style={{ color: "#e60000", fontWeight: 900 }}>
            OUTBOUND
          </Title>
          <Group gap="xs">
            <Button
      ...
      {/* Main content in standard 2-column layout (no tabs) */}
      <Box p="md">
        <Group align="flex-start" gap="md" style={{ flexWrap: "nowrap" }}>
          {/* LEFT COLUMN: Form Outbound Langsung */}
          <Paper withBorder p="md" style={{ width: 280, flexShrink: 0, background: "#fff" }}>
            <Group gap="xs" mb="sm">
          ...
          {/* RIGHT COLUMN: Pending Pickings list + History Table */}
          <Box style={{ flex: 1, minWidth: 0 }}>
            {/* PENDING PICKING PLANS */}
            <Paper withBorder p="md" mb="md" style={{ background: "#fff" }}>
              <Group gap="xs" mb="sm">
                  ...
                  {filteredPending.map((p: any) => (
                    <Grid.Col key={p.no_ref} span={{ base: 12, md: 6 }}>
                      <Card withBorder p="xs" radius="md" style={{ background: "#f8fafc" }}>
                        ...
                        <Divider my={4} />
                        <Table size="xs" withColumnBorders style={{ fontSize: 9, background: "#fff" }}>
            ...
            <Paper withBorder p="md" style={{ background: "#fff" }}>
